  ...
  return (
    <>
      ...
      <p className="fs-5 col-md-8">
        Quickly and easily get started with Bootstrap's compiled, production-ready files with this
        barebones example featuring some basic HTML and helpful links. Download all our examples to
        get started.
      </p>

      <div className="mb-5">
        <Link href="/docs/5.3/examples/" className="btn btn-primary btn-lg px-4">
          Download examples
        </Link>
      </div>
