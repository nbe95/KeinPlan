...
const KaPlanIcon = (props: IconProps) => {
  return (
    <svg version="1.1" id="svg1" width={props.width} height={props.height} viewBox="0 0 32 32">
      <defs id="defs1">
      ...
      <g transform="translate(2.2212974,17.227187)">
        <path fill="currentColor" d="m -0.06697,12.933031 h 28.000001 v -2 H -0.06697 Z" />
        <path
          fill="currentColor"
